        ...
        <>
            <div className="about-section">
                ...
                <div className="about-desc">
                    <p>
                        My focus lies in solving real-world problems through clean,
                        scalable, and user-friendly web applications.
                    </p>
                    <p>
                        I am a Motivated Full Stack Developer with expertise in React,
                        Node.js, Express.js, and PostgreSQL. Adept at creating user-centric,
                        scalable applications. Passionate about solving real-world problems
                    ...
                    <div className="skill-l">
                        <ul>
                            <li>
                                ...
                                HTML5, CSS3, Material Ul
                            </li>
                            <li>
                                <strong>Backend</strong>: Node.js, Express.js, REST APls,
                                WebSocket's
                            </li>
                            <li>
                                <strong>Database</strong>: PostgresSQL, MongoDB, Redis
                            </li>
                            <li>
                                <strong>Testing</strong>: Jest, Vitest
                            </li>
                            <li>
                                <strong>Others</strong>: Linux, Git, GraphQL, Firebase
                            </li>
                        </ul>
                    </div>
                </div>
